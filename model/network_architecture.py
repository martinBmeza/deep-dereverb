...
def autoencoder():
    ...
    #ENCODER
    enc = tfkl.Conv2D(64, kernel_size=(10,5), strides=2, padding='SAME', input_shape=(256,256,1), name='CONV1')(reverb_norm)
    enc_1 = tfkl.LeakyReLU(alpha = 0.2, name = 'ACT1')(enc)

    enc_2 = tfkl.Conv2D(128, kernel_size=(10,5), strides=2, padding='SAME', name='CONV2')(enc_1)
    enc_2 = tfkl.BatchNormalization(name='BATCH2')(enc_2)
    enc_2 = tfkl.LeakyReLU(alpha = 0.2, name='ACT2')(enc_2)

    enc_3 = tfkl.Conv2D(256, kernel_size=(10,5), strides=2, padding='SAME', name='CONV3')(enc_2)
    enc_3 = tfkl.BatchNormalization(name='BATCH3')(enc_3)
    enc_3 = tfkl.LeakyReLU(alpha = 0.2, name='ACT3')(enc_3)

    enc_4 = tfkl.Conv2D(512, kernel_size=(10,5), strides=2, padding='SAME', name='CONV4')(enc_3)
    enc_4 = tfkl.BatchNormalization(name='BATCH4')(enc_4)
    enc_4 = tfkl.LeakyReLU(alpha = 0.2, name='ACT4')(enc_4)

    enc_5 = tfkl.Conv2D(512, kernel_size=(10,5), strides=2, padding='SAME', name='CONV5')(enc_4)
    enc_5 = tfkl.BatchNormalization(name='BATCH5')(enc_5)
    enc_5 = tfkl.LeakyReLU(alpha = 0.2, name='ACT5')(enc_5)

    enc_6 = tfkl.Conv2D(512, kernel_size=(10,5), strides=2, padding='SAME', name='CONV6')(enc_5)
    enc_6 = tfkl.BatchNormalization(name = 'BATCH6')(enc_6)
    enc_6 = tfkl.LeakyReLU(alpha = 0.2, name='ACT6')(enc_6)

    enc_7 = tfkl.Conv2D(512, kernel_size=(10,5), strides=2, padding='SAME', name='CONV7')(enc_6)
    enc_7 = tfkl.BatchNormalization(name = 'BATCH7')(enc_7)
    enc_7 = tfkl.LeakyReLU(alpha = 0.2, name='ACT7')(enc_7)

    enc_8 = tfkl.Conv2D(512, kernel_size=(10,5), strides=2, padding='SAME', name='CONV8')(enc_7)
    ...
    dec = tfkl.Conv2D(512, kernel_size=(10,5), strides=1, padding='SAME', name='CONV9')(dec)
    ...
    dec = tfkl.Conv2D(512, kernel_size=(10,5), strides=1, padding='SAME', name='CONV10')(dec)
    ...
    dec = tfkl.UpSampling2D(size=(2,2), interpolation = 'nearest')(dec)
    dec = tfkl.Conv2D(512, kernel_size=(10,5), strides=1, padding='SAME', name='CONV11')(dec)
    ...
    dec = tfkl.UpSampling2D(size=(2,2), interpolation = 'nearest')(dec)
    dec = tfkl.Conv2D(512, kernel_size=(10,5), strides=1, padding='SAME', name='CONV12')(dec)
    ...
    dec = tfkl.Conv2D(256, kernel_size=(10,5), strides=1, padding='SAME', name='CONV13')(dec)
    ...
    dec = tfkl.UpSampling2D(size=(2,2), interpolation = 'nearest')(dec)
    dec = tfkl.Conv2D(128, kernel_size=(10,5), strides=1, padding='SAME', name='CONV14')(dec)
    ...
    dec = tfkl.UpSampling2D(size=(2,2), interpolation = 'nearest')(dec)
    dec = tfkl.Conv2D(64, kernel_size=(10,5), strides=1, padding='SAME', name='CONV15')(dec)
    ...
    dec = tfkl.UpSampling2D(size=(2,2), interpolation = 'nearest')(dec)
    dec = tfkl.Conv2D(1, kernel_size=(10,5), strides=1, padding='SAME', name='CONV16')(dec)
